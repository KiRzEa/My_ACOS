...
if __name__ == '__main__':
    ...
    wf = cs.open(base_dir+'/My_ACOS/Extract-Classify-ACOS/tokenized_data/'+domian_type+'_test_pair_1st.tsv', 'w')
    process(f, wf)

    f = cs.open(cur_dir+'_1st'+'/valid.txt', 'r').readlines()
    wf = cs.open(base_dir+'/My_ACOS/Extract-Classify-ACOS/tokenized_data/'+domian_type+'_dev_pair_1st.tsv', 'w')
    process(f, wf)